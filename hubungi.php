		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<h3>Pertanyaan<small> (Sila sertakan dengan nombor telefon)</small></h3>
					...
					<div class="form-group">
						<textarea class="form-control" id="message" rows="3" placeholder="Pesanan"></textarea>
					</div>
					<div class="form-group">
						<button class="btn btn-lg btn-block" style="margin-left: 0; background-color: #027878; color: #ffffff;">Hantar</button>
					</div>
				</div>
				<div class="col-xs-12 col-sm-5 col-sm-offset-1">
					<h3>Hubungi</h3>
					<p>Tel : +609-7711087 (Pejabat)<br>+6012-5188194 (En. Irman)<br>+6017-2137034 (Ustaz Nasrudin Sidi)</p>
					<p>Fax : 609-7711708</p>
					<p>Thailand : 0851063033 | 0950924645</p>
				</div>
			</div>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.4946077633267!2d102.23943701471347!3d6.198287328578193!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31b6b1fb37e8fe9f%3A0x97d09dad272801e6!2sSekolah+Menengah+Islam+Al-Husna!5e0!3m2!1sen!2smy!4v1518605296846" width="1200" height="500" frameborder="0" allowfullscreen></iframe>
		</div>
	</section>
