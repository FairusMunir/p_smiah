...
<head>
	...
	<title>SMIAH | Sijil Perakuan</title>
...
<body>
	...
	<section class="sect-content">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<h3>Sijil Perakuan</h3>
					<div class="col-sm-4">
						<figure>
							<img style="width: 350px; height: auto;" src="./img/sijil1.jpg">
							<figcaption>SIJIL PERAKUAN DARI KEMENTERIAN PENDIDIKAN</figcaption>
						</figure>
					</div>
					<div class="col-sm-4">
						<figure>
							<img style="width: 350px; height: auto;" src="./img/sijil2.jpg">
							<figcaption>SIJIL PERAKUAN DARI MAJLIS AGAMA ISLAM DAN ADAT ISTIADAT NEGERI KELANTAN</figcaption>
						</figure>
					</div>
					<div class="col-sm-4">
						<figure>
							<img style="width: 350px; height: auto;" src="./img/sijil3.jpg">
							<figcaption>SIJIL PERAKUAN DARI KERAJAAN MALAYSIA</figcaption>
						</figure>
					</div>
				</div>
			</div>
