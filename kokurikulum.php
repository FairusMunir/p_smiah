...
<head>
	...
	<title>SMIAH | Ko-Kurikulum</title>
		...
		<div class="container">
			<div class="row">
				<div col-xs-12 col-sm-12>
					<table class="table table-bordered">
						...
						<tbody>
						    <tr>
							    ...
							    <td>
							    	<ul>
							    		<li>Persatuan Bahasa (Bahasa Melayu, Bahasa Inggeris, Bahasa Arab)</li>
							    		<li>Persatuan Sains & Matematik</li>
							    		<li>Persatuan Kemahiran (Perdagangan, Kemahiran Hidup, Reka Bentuk & Teknologi, Perdagangan)</li>
							    	</ul>
							    </td>
						    </tr>
						    <tr>
					...
					<div class="col-sm-3"><img class="img-responsive" src="./img/kokurikulum1.jpg"></div>
					<div class="col-sm-3"><img class="img-responsive" src="./img/kokurikulum2.jpg"></div>
					<div class="col-sm-3"><img class="img-responsive" src="./img/kokurikulum3.jpg"></div>
					<div class="col-sm-3"><img class="img-responsive" src="./img/kokurikulum4.jpg"></div>
