...
<body>
	...
	<div class="sidenav">
		...
		<a href="cemerlang_spm.php?token=<?php echo $_SESSION['token'] ?>" class="active">Pelajar Cemerlang SPM</a>
		...
		<div>
			<div class="container">
				<div class="row">
								...
								<tr>
								    ...
								    <td>
								    	<form action="controller.php" method="post">
								    		<input type="hidden" name="action" value="deleteSPM">
								    		<input type="hidden" name="idPelajar" value="<?php echo $spmStudent[$i]["studentId"] ?>">
					...
					<button type="button" class="button_style" data-toggle="modal" data-target="#cemerlang_spm" style="float: right;">Tambah Pelajar</button>
					<!-- Modal -->
					  <div class="modal fade" id="cemerlang_spm" role="dialog">
					    <div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h4 class="modal-title">Pelajar Cemerlang SPM</h4>
					        </div>
					          ...
					          <form class="form-horizontal" action="controller.php" method="post">
							    ...
							    <div class="form-group">
							      ...
							      <div class="col-sm-8">          
							        ...
							        <input type="hidden" name="action" value="addSPM">
							      </div>
							    </div>
							    <div class="form-group">        
